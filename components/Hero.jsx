        ...
        <div className="container mx-auto">
            <div className="flex justify-between gap-x-8">
                ...
                <div className="hidden xl:flex relative">
                    ...
                    {/*Badge 2*/}
                    <Badge containerStyles="absolute top-[80%] -left-[1rem]" icon={<RiTodoFill />} endCountNum={6} endCountText="k" 
                    badgeText="Finished Proyects"/>
                    {/*Badge 3*/}
                    <Badge containerStyles="absolute top-[55%] -right-8" icon={<RiTeamFill />} endCountNum={9} endCountText="k"
